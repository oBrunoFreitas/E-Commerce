<?php if(!class_exists('Rain\Tpl')){exit;}?>        
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2019 Bruno Freitas. <a href="https://github.com/oBrunoFreitas" target="_blank">https://github.com/oBrunoFreitas</a></p>
                    </div>
                </div>
    ...
    <!-- jQuery sticky menu -->
    <script src="/res/loja/js/owl.carousel.min.js"></script>
    <script src="/res/loja/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/res/loja/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/res/loja/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/res/loja/js/bxslider.min.js"></script>
    <script type="text/javascript" src="/res/loja/js/script.slider.js"></script>
  </body>
</html>